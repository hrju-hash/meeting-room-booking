...
class UI {
    ...
    getKoreanHolidays(year) {
        ...
        if (year === 2024) {
            ...
            // 2027년 설날: 1월 21-23일
            holidays['2027-01-21'] = '설날';
            holidays['2027-01-22'] = '설날';
            holidays['2027-01-23'] = '설날';
            // 2027년 추석: 9월 29일-10월 1일
            holidays['2027-09-29'] = '추석';
            holidays['2027-09-30'] = '추석';
            holidays['2027-10-01'] = '추석';
        }
        ...
        // 현충일 대체공휴일 (2027년 6월 6일이 일요일이므로 6월 7일이 대체공휴일)
        if (year === 2024) {
            holidays['2024-06-07'] = '대체공휴일';
        } else if (year === 2027) {
            holidays['2027-06-07'] = '대체공휴일';
        }
        
        // 광복절 대체공휴일 (2026년 8월 15일이 토요일이므로 8월 17일이 대체공휴일, 2027년 8월 15일이 일요일이므로 8월 16일이 대체공휴일)
        if (year === 2024) {
            ...
            holidays['2027-08-16'] = '대체공휴일';
        }
        
        // 개천절 대체공휴일 (2026년 10월 3일이 토요일이므로 10월 5일이 대체공휴일, 2027년 10월 3일이 일요일이므로 10월 4일이 대체공휴일)
        if (year === 2024) {
            ...
            holidays['2027-10-04'] = '대체공휴일';
        }
        
        // 한글날 대체공휴일 (2027년 10월 9일이 토요일이므로 10월 10일이 대체공휴일)
        if (year === 2024) {
            holidays['2024-10-10'] = '대체공휴일';
        } else if (year === 2025) {
            holidays['2025-10-10'] = '대체공휴일';
        } else if (year === 2027) {
            holidays['2027-10-10'] = '대체공휴일';
        }
        
        // 성탄절 대체공휴일 (2027년 12월 25일이 토요일이므로 12월 27일이 대체공휴일)
        if (year === 2027) {
            holidays['2027-12-27'] = '대체공휴일';
        }
        ...
        // 2026년 설날 대체공휴일 없음 (2월 20일은 대체공휴일 아님)
        // 2027년 설날 대체공휴일 없음 (설날 연휴가 주말과 겹치지 않음)
        ...
        // 2027년 추석 대체공휴일 없음 (추석 연휴가 주말과 겹치지 않음)
