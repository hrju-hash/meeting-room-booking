...
class UI {
    ...
    getKoreanHolidays(year) {
        ...
        if (year === 2024) {
            ...
            // 2027년 설날: 1월 27-29일
            holidays['2027-01-27'] = '설날';
            holidays['2027-01-28'] = '설날';
            holidays['2027-01-29'] = '설날';
            // 2027년 추석: 10월 4-6일
            holidays['2027-10-04'] = '추석';
            holidays['2027-10-05'] = '추석';
            holidays['2027-10-06'] = '추석';
        }
        ...
        if (year === 2024) {
            ...
            holidays['2027-01-26'] = '대체공휴일';
            holidays['2027-01-30'] = '대체공휴일';
        }
        ...
        if (year === 2024) {
            ...
            holidays['2027-10-03'] = '대체공휴일';
            holidays['2027-10-07'] = '대체공휴일';
        }
