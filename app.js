...
class UI {
    ...
    getKoreanHolidays(year) {
        ...
        if (year === 2024) {
            ...
            // 2027년 설날: 2월 6-8일
            holidays['2027-02-06'] = '설날';
            holidays['2027-02-07'] = '설날';
            holidays['2027-02-08'] = '설날';
            // 2027년 추석: 9월 14-16일
            holidays['2027-09-14'] = '추석';
            holidays['2027-09-15'] = '추석';
            holidays['2027-09-16'] = '추석';
        }
        ...
        // 한글날 대체공휴일 (2027년 10월 9일이 월요일이므로 10월 11일이 대체공휴일)
        if (year === 2024) {
            holidays['2024-10-10'] = '대체공휴일';
        } else if (year === 2025) {
            holidays['2025-10-10'] = '대체공휴일';
        } else if (year === 2027) {
            holidays['2027-10-11'] = '대체공휴일';
        }
